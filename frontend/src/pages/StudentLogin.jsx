    ...
    return (
        <main className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
                {/* Updated Card UI to match SignUp: rounded-[28px], bg-[#FFF4DE]/95 */}
                <div className="w-full max-w-sm rounded-[28px] bg-[#FFF4DE]/95 px-6 py-8 shadow-[0_30px_60px_-40px_rgba(14,29,45,0.8)] sm:px-8">
                    <button
                        type="button"
                        onClick={() => navigate('/')}
