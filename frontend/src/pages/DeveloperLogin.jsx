...
function InputField({ label, type, placeholder, icon: Icon }) {
        ...
        <label className="flex w-full flex-col gap-2 text-sm font-semibold text-[#204060]">
            ...
            <div className="relative flex items-center">
                ...
                <input
                    ...
                    className={`w-full rounded-2xl border border-[#204060]/20 bg-[#BED4C5]/40 py-3 text-base text-[#0E1D2D] placeholder:text-[#204060]/60 focus:outline-none focus:ring-2 focus:ring-[#6F9FA5]/50 ${
                        Icon ? 'pl-12' : 'pl-4'
    ...
    return (
        <main className="relative min-h-screen overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
                {/* Updated Card UI to match SignUp: rounded-[28px], bg-[#FFF4DE]/95, max-w-md */}
                <div className="w-full max-w-md rounded-[28px] bg-[#FFF4DE]/95 px-6 py-8 shadow-[0_30px_60px_-40px_rgba(14,29,45,0.8)] sm:px-8">
                    <button
                        type="button"
                        onClick={() => navigate('/')}
